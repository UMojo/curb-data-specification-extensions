...
| `street_number` | String | Optional | Street number or range (e.g., `112`, `112A`, `7/1`, `112-116`). Format depends on local conventions and may include letters, slashes, or ranges. This field helps locate the curb zone along the street grid and is typically sourced from the publisher’s geocoding process. |
