...
| `address_number` | String | Optional | Address number or range (e.g. `112`, `112A`, `7/1`, `112–116`). Format depends on local conventions and may include letters, slashes, or ranges. This field helps locate the curb zone along the street grid and comes from the creator’s own geocoding process. |
